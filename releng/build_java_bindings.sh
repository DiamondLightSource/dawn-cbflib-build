...
make -f $CBF_MAKEFILE $CBF_TESTS javawrapper "$CBF_COMPILE" CBFLIB_DONT_BUILD_HDF5=yes CBF_NO_REGEX=yes CBFLIB_DONT_USE_LOCAL_REGEX=yes CBFLIB_DONT_USE_LOCAL_SWIG=yes CBFLIB_DONT_USE_LOCAL_SWIG_FORTRAN=yes CBFLIB_DONT_USE_PYCIFRW=yes CBFLIB_DONT_USE_PY2CIFRW=yes CBFLIB_DONT_USE_PY3CIFRW=yes NOFORTRAN=yes
